...
<td>
    <div class="qvwc-size-field">
        <label for="<?php echo esc_attr( $field_Key ); ?>_width">
            <div><b><?php esc_html_e('Width', 'product-quickview-for-woocommerce'); ?></b></div>
        ...
        <label for="<?php echo esc_attr( $field_Key ); ?>_height">
            <div><b><?php esc_html_e('Height', 'product-quickview-for-woocommerce'); ?></b></div>
